      ...
      <div className="absolute top-32 right-10 md:right-24 z-20 hidden lg:block animate-float">
        <div className="relative w-32 h-32 md:w-40 md:h-40 flex items-center justify-center">
          ...
          <div className="absolute inset-0 flex items-center justify-center flex-col bg-white/20 backdrop-blur-md rounded-full m-6 border border-white/30">
            <span className="text-3xl md:text-4xl font-display font-black text-white">20</span>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-6 animate-appear-fast mb-12 md:mb-16 w-full sm:w-auto px-6 sm:px-0">
            ...
            >
              ...
              <div className="absolute inset-0 bg-azure translate-x-full group-hover:translate-x-0 transition-transform duration-500"></div>
            </button>
          ...
          <div className="hidden md:flex items-center gap-12 opacity-80 hover:opacity-100 transition-opacity animate-fade-in-delayed">
            ...
            <div className="flex gap-10">
               <img src="https://upload.wikimedia.org/wikipedia/commons/b/b7/Flag_of_Europe.svg" className="h-5 grayscale brightness-200 drop-shadow-lg" alt="EU" />
               <img src="https://upload.wikimedia.org/wikipedia/commons/0/03/Flag_of_Italy.svg" className="h-5 grayscale brightness-200 drop-shadow-lg" alt="Italy" />
               <div className="text-white font-bold text-[10px] flex items-center gap-2 uppercase tracking-tighter drop-shadow-md">Europe Direct Salerno</div>
            </div>
          </div>
        </div>
      </div>
